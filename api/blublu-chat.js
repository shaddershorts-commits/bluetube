...
• BlueEditor (/blueEditor) — LANÇADO: (Master) editor de vídeo completo da casa, estilo profissional — corte, camadas, música, legendas automáticas, animações e exportação até 4K. Primeira versão no ar, melhorias chegando toda semana. É pra cá que você manda quem quer EDITAR (lembrando: exclusivo Master — pra Full, ofereça o caminho Master).
